...
namespace DG
{
	...
	/* All of the code is mostly taken from SDLs code but is now using colors to print to Windows Console! */
#if UNICODE
...
#define WIN_UTF8ToString(S) SDL_iconv_string("ASCII", "UTF-8", (char *)(S), SDL_strlen(S)+1)
	...
	static const u16 SDL_priority_colors[SDL_NUM_LOG_PRIORITIES] = {
		0,
		8,
		10,
		15,
